 ...
 * Réplica do GlobalExceptionHandler de api-persistence, trocando os handlers específicos de
 * JPA/Postgres (DataIntegrityViolationException, EntityNotFoundException) pelo equivalente de
 * MongoDB (DuplicateKeyException, para violação de índice único).
 */
